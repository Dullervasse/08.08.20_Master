...
print("This is the test for pyrF.")

# set working directory to folder with FoldX output files
os.chdir("/Users/Marie/Desktop/DataCrunching/pyrf")
...
# Define which pyrF chain to analyse
print("Which chain do you want to analyse?")
print("1: chain A")
print("2: chain B")

chain = input("Please answer here (1/2): ")
...
for i in range(0,len(PairList)):
    ...
    if len(energies) > 21 or chain == "1":
        ...
        # Select data from desired chain
        if chain == "1":
            AAnames = AAnames[:21]
        elif chain == "2":
            AAnames = AAnames[21:]
    ...
    elif len(energies) < 21 and chain == "2":
        pass
...
while processing == True:
    ...
    if func == "1":
        ...
        plt.title("Predicted stabilities of pyrF mutants", fontsize = 12)
    ...
    # Show only destabilised mutations
        ...
        plt.yticks(fontsize=12)
        plt.ylim([0,25])
        plt.savefig("pyrf_destabilised", transparent = True, )
